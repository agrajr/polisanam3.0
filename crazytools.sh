...
sleep 2
clear
toilet -f future "CYBER VICHU" | lolcat
sleep 2
clear
...
echo   "Creadby  : CYBER VICHU $white" |lolcat
echo   "Contact  : Instagram.com/i_am_cyber80 $white" |lolcat
echo $b"============================================="
...
00) echo "created by : CYBER VICHU" | lolcat
exit
;;
